...
export default function ModalSelectListIndex (props:ModalProgressProps){
      ...
      if(json.Break !== undefined){
        ...
        switch (Token){
          case "SelectListIndex":
            ...
            Items = Items.split(",")
            Items.forEach(function(item:any, index: any, array: any) {
    ...
    function Confirm(event:any , jsonProp:any){
    ...
    function ReturnJSX(ID:string , json:any){
    ...
    function UpdateSelected (event:any){
...
function triggerBase64Download(RCDATA: string, arg1: any) {
